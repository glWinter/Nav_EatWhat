package com.winter.nav_eatwhat.utils.dialog;
...
public class MyLoading extends Dialog {
    ...
    public MyLoading(Context context, int themeResId) {
    ...
    public static class Builder {
        ...
        public MyLoading create() {
            LayoutInflater inflater = LayoutInflater.from(context);
            View view = inflater.inflate(R.layout.dialog_loading, null);
            MyLoading mmLoading = new MyLoading(context, R.style.MyDialogStyle);
